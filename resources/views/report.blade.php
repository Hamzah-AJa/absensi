                        ...
                        <tbody>
                            ...
                            @foreach ($m as $a)
                                <tr>
                                    ...
                                    <td>{{ $a->nama }}</td>
                                    <td>{{ $a->email ?? '-' }}</td>
                                    <td>{{ $a->absensis->where('keterangan', 'Hadir')->whereBetween('tanggal', [$from, $to])->count() ?:'-' }}
                                    </td>
                                    <td>{{ $a->absensis->where('keterangan', 'Ijin')->whereBetween('tanggal', [$from, $to])->count() ?:'-' }}
                                    </td>
                                    <td>{{ $a->absensis->where('keterangan', 'Sakit')->whereBetween('tanggal', [$from, $to])->count() ?:'-' }}
                                    </td>
                                    <td>{{ $a->absensis->where('keterangan', 'Alfa')->whereBetween('tanggal', [$from, $to])->count() ?:'-' }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
